...
```typescript
import { ListPlaybackIdsResponseBody } from "@fastpix/fastpix-node/models/operations";

let value: ListPlaybackIdsResponseBody = {
  success: true,
  data: [
    {
...
| `data`                                                                             | [operations.ListPlaybackIdsData](../../models/operations/listplaybackidsdata.md)[] | :heavy_minus_sign:                                                                 | N/A                                                                                |                                                                                    |
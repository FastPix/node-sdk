...
```typescript
import { UpdateLiveStreamUserAgentRestrictionsResponseBody } from "@fastpix/fastpix-node/models/operations";

let value: UpdateLiveStreamUserAgentRestrictionsResponseBody = {
  success: true,
  data: {
    defaultPolicy: "allow",
    allow: [

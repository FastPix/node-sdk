 ...
 */
export type CreateLiveStreamResponseDTO = {
  /**
...
/** @internal */
export const CreateLiveStreamResponseDTO$inboundSchema: z.ZodMiniType<
...
export function createLiveStreamResponseDTOFromJSON(
  jsonString: string,
): SafeParseResult<CreateLiveStreamResponseDTO, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateLiveStreamResponseDTO$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateLiveStreamResponseDTO' from JSON`,
  );
}

 ...
 */
export function manageVideosUpdateMediaTrack(
  client: FastpixCore,
  ...
  Result<
    ...
    | errors.TrackDuplicateRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateMediaTrackRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateTrackRequest, {
    explode: true,
  });
  ...
  >(
    ...
    M.jsonErr(400, errors.TrackDuplicateRequestError$inboundSchema),

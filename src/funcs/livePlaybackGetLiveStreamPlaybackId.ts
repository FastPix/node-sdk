 ...
 */
export function livePlaybackGetLiveStreamPlaybackId(
  client: FastpixCore,
  ...
  Result<
    ...
    | errors.NotFoundErrorPlaybackId
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLiveStreamPlaybackIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PlaybackIdSuccessResponse$inboundSchema),
    M.jsonErr(401, errors.UnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.InvalidPermissionError$inboundSchema),
    M.jsonErr(404, errors.NotFoundErrorPlaybackId$inboundSchema),

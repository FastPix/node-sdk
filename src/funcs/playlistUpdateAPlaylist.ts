 ...
 */
export function playlistUpdateAPlaylist(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateAPlaylistRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdatePlaylistRequest, {
    explode: true,
  });

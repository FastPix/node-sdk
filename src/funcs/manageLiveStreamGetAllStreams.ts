 ...
 */
export function manageLiveStreamGetAllStreams(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllStreamsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetStreamsResponse$inboundSchema),

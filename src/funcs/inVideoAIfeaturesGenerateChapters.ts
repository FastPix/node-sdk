...
export function inVideoAIfeaturesGenerateChapters(
  ...
  Result<
    operations.UpdateMediaChaptersResponse,MyError
  >
> {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateMediaChaptersRequest$outboundSchema, value),
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateMediaChaptersResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {

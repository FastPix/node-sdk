 ...
 */
export function playlistAddMediaToPlaylist(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddMediaToPlaylistRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.PlaylistByIdResponse$inboundSchema),

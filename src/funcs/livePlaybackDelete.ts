...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeletePlaybackIdOfStreamRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeletePlaybackIdOfStreamResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.DeletePlaybackIdOfStreamResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {

 ...
 */
export function manageLiveStreamCompleteLiveStream(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CompleteLiveStreamRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([400, 401], errors.UnauthorizedError$inboundSchema),

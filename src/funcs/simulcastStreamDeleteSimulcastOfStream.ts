 ...
 */
export function simulcastStreamDeleteSimulcastOfStream(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSimulcastOfStreamRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SimulcastdeleteResponse$inboundSchema),

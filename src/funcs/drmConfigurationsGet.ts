...
export function drmConfigurationsGet(
  ...
  Result<
    operations.GetDrmConfigurationByIdResponse,MyError
  >
> {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetDrmConfigurationByIdRequest$outboundSchema, value),
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetDrmConfigurationByIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {

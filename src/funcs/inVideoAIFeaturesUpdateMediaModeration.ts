 ...
 */
export function inVideoAIFeaturesUpdateMediaModeration(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateMediaModerationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/on-demand/{mediaId}/moderation")(pathParams);

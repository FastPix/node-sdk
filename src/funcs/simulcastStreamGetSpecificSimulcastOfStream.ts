 ...
 */
export function simulcastStreamGetSpecificSimulcastOfStream(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSpecificSimulcastOfStreamRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SimulcastResponse$inboundSchema),

...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetLiveStreamByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetLiveStreamByIdResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetLiveStreamByIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {

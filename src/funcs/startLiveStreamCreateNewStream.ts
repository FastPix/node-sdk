 ...
 */
export function startLiveStreamCreateNewStream(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateLiveStreamRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.LiveStreamResponseDTO$inboundSchema),

 ...
 */
export function manageLiveStreamGetLiveStreamById(
  client: FastpixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLiveStreamByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LivestreamgetResponse$inboundSchema),

...
export function livePlaybackUpdateDomainRestrictions(
  client: FastpixCore,
  request: operations.UpdateLiveStreamDomainRestrictionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateLiveStreamDomainRestrictionsResponse,MyError
  >
> {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateLiveStreamDomainRestrictionsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    operations.UpdateLiveStreamDomainRestrictionsResponse,
    | FastpixError
    | ResponseValidationError
    | ConnectionError
    | RequestAbortedError
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateLiveStreamDomainRestrictionsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.UpdateLiveStreamDomainRestrictionsResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {

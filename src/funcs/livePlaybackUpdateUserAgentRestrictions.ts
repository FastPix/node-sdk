...
export function livePlaybackUpdateUserAgentRestrictions(
  client: FastpixCore,
  request: operations.UpdateLiveStreamUserAgentRestrictionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateLiveStreamUserAgentRestrictionsResponse,MyError
  >
> {
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateLiveStreamUserAgentRestrictionsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    operations.UpdateLiveStreamUserAgentRestrictionsResponse,MyError
  >(
    M.json(200, operations.UpdateLiveStreamUserAgentRestrictionsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.UpdateLiveStreamUserAgentRestrictionsResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {

...
import { inputVideoCreate } from "../funcs/inputVideoCreate.js";
import { inputVideoUpload } from "../funcs/inputVideoUpload.js";
...
export class InputVideo extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(inputVideoCreate(
      this,
      request,
      options,
    ));
  ...
  async upload(
    ...
    return unwrapAsync(inputVideoUpload(
      this,
      request,
      options,
    ));
